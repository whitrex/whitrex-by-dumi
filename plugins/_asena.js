...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'white ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'🔰 WHITEREX BOT PRIVATE 🔰\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
            var CMD_HELP = '';
            Asena.commands.map(
    ...
    Asena.addCommand({pattern: 'white ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'🔰 WHITEREX BOT PUBLIC 🔰\n\n' + CMD_HELP, MessageType.text
            );    
        } else {
            var CMD_HELP = '';
            Asena.commands.map(
