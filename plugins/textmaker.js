...
if (config.LANG == 'SI') desc_msg = 'අසීමිත ප්‍රවේශයක් සහිත පෙළ සාදන්න මෙවලම් පෙන්වයි.' 
if (os.userInfo().homedir !== clh.pay) return;
let wk = Config.WORKTYPE == 'public' ? false : true

Asena.addCommand({pattern: 'effectimg$', fromMe: wk, desc: desc_msg}, (async (message, match) => {
    var t1 = ''
    var t2 = ''
    var t3 = ''
    var t4 = ''
